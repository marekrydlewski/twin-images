...
def extract_bright(image, keypoints):
    ...
    for keypoint in keypoints:
        subimage = image[keypoint[0] - window: keypoint[0] + window][keypoint[1] - window: keypoint[1] + window]
...
score1 = distance_bright(desc1[0], desc2[1])
score2 = distance_bright(desc1[0], desc2[2])
print(score)
print(score1)
print(score2)

desc3 = extract_bright(img1, keypoints_own)
desc4 = extract_bright(img2, keypoints_own)
score3 = distance_bright(desc1[0], desc3[0])
